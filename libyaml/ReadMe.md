##LibYAML - Port For PS2

This is a Port of LibYAML for the PS2.

The yamlBuildPS2.sh script will set the Flags needed for your Compiler. (reccomended to be run as root)

Please See the Requirments Below and make sure they are met to ensure proper setup.
