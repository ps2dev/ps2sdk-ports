...
Most of the ports contains specific changes to make them work for the `ps2sdk`, however there are some ports included as a `git clone` that are being compiled using original source code, just adding the specficic `PS2` flags (using `cmake`).
