...
int main(int argc, char *argv[])
{
 ...
 print_result ("MMX BitNegation", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterBitNegation ((unsigned char *)src1,(unsigned char *)dst,15);
 print_result (" C  BitNegation", src1, NULL, dst);
 ...
 print_result ("MMX AddByte(3)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterAddByte ((unsigned char *)src1,(unsigned char *)dst,15, 3);
 print_result (" C  AddByte(3)", src1, NULL, dst);
 ...
 print_result ("MMX AddByteToHalf(3)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterAddByteToHalf ((unsigned char *)src1,(unsigned char *)dst,15, 3);
 print_result (" C  AddByteToHalf(3)", src1, NULL, dst);
 ...
 print_result ("MMX SubByte(3)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterSubByte ((unsigned char *)src1,(unsigned char *)dst,15, 3);
 print_result (" C  SubByte(3)", src1, NULL, dst);
 ...
 print_result ("MMX ShiftRight(1)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterShiftRight ((unsigned char *)src1,(unsigned char *)dst,15, 1);
 print_result (" C  ShiftRight(1)", src1, NULL, dst);
 ...
 print_result ("MMX MultByByte(3)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterMultByByte ((unsigned char *)src1,(unsigned char *)dst,15, 3);
 print_result (" C  MultByByte(3)", src1, NULL, dst);
 ...
 print_result ("MMX ShiftRightAndMultByByte(1,3)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterShiftRightAndMultByByte ((unsigned char *)src1,(unsigned char *)dst,15, 1, 3);
 print_result (" C  ShuftRightAndMultByByte(1,3)", src1, NULL, dst);
 ...
 print_result ("MMX ShiftLeftByte(3)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterShiftLeftByte ((unsigned char *)src1,(unsigned char *)dst,15, 3);
 print_result (" C  ShiftLeftByte(3)", src1, NULL, dst);
 ...
 print_result ("MMX ShiftLeft(3)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterShiftLeft ((unsigned char *)src1,(unsigned char *)dst,15, 3);
 print_result (" C  ShiftLeft(3)", src1, NULL, dst);
 ...
 print_result ("MMX BinarizeUsingThreshold(2)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterBinarizeUsingThreshold ((unsigned char *)src1,(unsigned char *)dst,15, 2);
 print_result (" C  BinarizeUsingThreshold(2)", src1, NULL, dst);
 ...
 print_result ("MMX ClipToRange(1,7)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterClipToRange ((unsigned char *)src1,(unsigned char *)dst,15, 1,7);
 print_result (" C  ClipToRange(1,7)", src1, NULL, dst);
 ...
 print_result ("MMX NormalizeLinear(0,33,0,255)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterNormalizeLinear ((unsigned char *)src1,(unsigned char *)dst,15, 0,33,0,255);
 print_result (" C  NormalizeLinear(0,33,0,255)", src1, NULL, dst);
 ...
 setup_src(src1, src2);
 SDL_imageFilterAddUint ((unsigned char *)src1,(unsigned char *)dst,15, 0x01020304);
 print_result ("MMX AddUint(0x01020304)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterAddUint ((unsigned char *)src1,(unsigned char *)dst,15, 0x01020304);
 print_result (" C  AddUint(0x01020304)", src1, NULL, dst);
 ...
 setup_src(src1, src2);
 SDL_imageFilterSubUint ((unsigned char *)src1,(unsigned char *)dst,15, 0x01020304);
 print_result ("MMX SubUint(0x01020304)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterSubUint ((unsigned char *)src1,(unsigned char *)dst,15, 0x01020304);
 print_result (" C  SubUint(0x01020304)", src1, NULL, dst);
 ...
 setup_src(src1, src2);
 SDL_imageFilterShiftRightUint ((unsigned char *)src1,(unsigned char *)dst,15, 4);
 print_result ("MMX ShiftRightUint(4)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterShiftRightUint ((unsigned char *)src1,(unsigned char *)dst,15, 4);
 print_result (" C  ShiftRightUint(4)", src1, NULL, dst);
 ...
 setup_src(src1, src2);
 SDL_imageFilterShiftLeftUint ((unsigned char *)src1,(unsigned char *)dst,15, 4);
 print_result ("MMX ShiftLeftUint(4)", src1, NULL, dst);

 SDL_imageFilterMMXoff();

 setup_src(src1, src2);
 SDL_imageFilterShiftLeftUint ((unsigned char *)src1,(unsigned char *)dst,15, 4);
 print_result (" C  ShiftLeftUint(4)", src1, NULL, dst);
