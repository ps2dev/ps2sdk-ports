...
#define GROUND_R (0.3f) 	// ground color for when there's no texture
#define GROUND_G (0.3f)
#define GROUND_B (0.3f)

const float ground_scale __attribute((aligned(16))) = 1.0f/1.0f;	// ground texture scale (1/size)
const float ground_ofsx __attribute((aligned(16))) = 0.5;		// offset of ground texture
const float ground_ofsy __attribute((aligned(16))) = 0.5;
const float sky_scale 	__attribute((aligned(16))) = 1.0f/4.0f;	// sky texture scale (1/size)
const float sky_height 	__attribute((aligned(16))) = 1.0f;		// sky height above viewpoint
