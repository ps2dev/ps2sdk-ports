...
build_ee gsKit -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCMAKE_C_STANDARD=99
...
build_ee enet -DCMAKE_C_STANDARD=99
...
build_ee libarchive -DBUILD_SHARED_LIBS=OFF -DENABLE_WERROR=OFF -DCMAKE_C_STANDARD=99
