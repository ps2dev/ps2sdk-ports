...
all: aalib expat freetype2 libconfig libid3tag zlib libjpeg libmad libmikmod libpng libtap lua romfs sdl sdlgfx sdlimage sdlmixer sdlttf ucl
# libtiff stlport madplay ode
